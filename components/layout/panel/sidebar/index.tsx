...
export default function PanelSidebar() {
  return (
    <div
    //  :className="{'dark text-white-dark' : $store.app.semidark}"
    >
      <nav
        x-data="sidebar"
          ...
          >
            <li className="menu nav-item">
              <button
                ...
                // :className="{'active' : activeDropdown === 'dashboard'}"
              ...
              >
                ...
                <div
                  ...
                  // :className="{'!rotate-90' : activeDropdown === 'dashboard'}"
                >
                  <svg
                    width="16"
                    height="16"
            ...
            <li className="nav-item">
              <ul>
                ...
                <li className="nav-item">
                  <a href="apps-mailbox.html" className="group">
                    <div className="flex items-center">
                      <svg
                        className="shrink-0 group-hover:!text-primary"
                        width="20"
                ...
                <li className="nav-item">
                  <a href="apps-todolist.html" className="group">
                    <div className="flex items-center">
                      {/* <svg
                        className="shrink-0 group-hover:!text-primary"
                        width="20"
                ...
                <li className="nav-item">
                  <a href="apps-notes.html" className="group">
                    <div className="flex items-center">
                      {/* <svg
                        className="shrink-0 group-hover:!text-primary"
                        width="20"
                ...
                <li className="nav-item">
                  <a href="apps-scrumboard.html" className="group">
                    <div className="flex items-center">
                      {/* <svg
                        className="shrink-0 group-hover:!text-primary"
                        width="20"
                ...
                <li className="nav-item">
                  <a href="apps-contacts.html" className="group">
                    <div className="flex items-center">
                      {/* <svg
                        className="shrink-0 group-hover:!text-primary"
                        width="20"
                ...
                <li className="menu nav-item">
                  <button
                    type="button"
                    className="nav-link group"
                    // :className="{'active' : activeDropdown === 'invoice'}"
                  ...
                  >
                    ...
                    <div
                      className="rtl:rotate-180"
                      // :className="{'!rotate-90' : activeDropdown === 'invoice'}"
                    >
                      <svg
                        width="16"
                        height="16"
                ...
                <li className="nav-item">
                  <a href="apps-calendar.html" className="group">
                    <div className="flex items-center">
                      <svg
                        className="shrink-0 group-hover:!text-primary"
                        width="20"
            ...
            <li className="menu nav-item">
              <button
                type="button"
                className="nav-link group"
                // :className="{'active' : activeDropdown === 'components'}"
              ...
              >
                ...
                <div
                  className="rtl:rotate-180"
                  // :className="{'!rotate-90' : activeDropdown === 'components'}"
                >
                  <svg
                    width="16"
                    height="16"
              ...
              <ul
                x-cloak
                x-show="activeDropdown === 'components'"
                x-collapse
                className="sub-menu text-gray-500"
              >
                <li>
            ...
            <li className="menu nav-item">
              <button
                type="button"
                className="nav-link group"
                // :className="{'active' : activeDropdown === 'elements'}"
              ...
              >
                ...
                <div
                  className="rtl:rotate-180"
                  // :className="{'!rotate-90' : activeDropdown === 'elements'}"
                >
                  <svg
                    width="16"
                    height="16"
              ...
              <ul
                x-cloak
                x-show="activeDropdown === 'elements'"
                x-collapse
                className="sub-menu text-gray-500"
              >
                <li>
            ...
            <li className="menu nav-item">
              <a href="charts.html" className="nav-link group">
                <div className="flex items-center">
                  <svg
                    className="shrink-0 group-hover:!text-primary"
                    width="20"
            ...
            <li className="menu nav-item">
              <a href="widgets.html" className="nav-link group">
                <div className="flex items-center">
                  <svg
                    className="shrink-0 group-hover:!text-primary"
                    width="20"
            ...
            <li className="menu nav-item">
              <a href="font-icons.html" className="nav-link group">
                <div className="flex items-center">
                  {/* <svg
                    className="shrink-0 group-hover:!text-primary"
                    width="20"
            ...
            <li className="menu nav-item">
              <a href="dragndrop.html" className="nav-link group">
                <div className="flex items-center">
                  <svg
                    className="shrink-0 group-hover:!text-primary"
                    width="20"
            ...
            <li className="menu nav-item">
              <a href="tables.html" className="nav-link group">
                <div className="flex items-center">
                  <svg
                    className="shrink-0 group-hover:!text-primary"
                    width="20"
            ...
            <li className="menu nav-item">
              <button
                type="button"
                className="nav-link group"
                // :className=" {'active' : activeDropdown==='datatables' }"
              ...
              >
                ...
                <div
                  className="rtl:rotate-180"
                  // :className="{'!rotate-90' : activeDropdown === 'datatables'}"
                >
                  <svg
                    width="16"
                    height="16"
              ...
              <ul
                x-cloak
                x-show="activeDropdown === 'datatables'"
                x-collapse
                className="sub-menu text-gray-500"
              >
                <li>
            ...
            <li className="menu nav-item">
              <button
                type="button"
                className="nav-link group"
                // :className="{'active' : activeDropdown === 'forms'}"
              ...
              >
                ...
                <div
                  className="rtl:rotate-180"
                  // :className="{'!rotate-90' : activeDropdown === 'forms'}"
                >
                  <svg
                    width="16"
                    height="16"
            ...
            <li className="menu nav-item">
              <button
                type="button"
                className="nav-link group"
                // :className="{'active' : activeDropdown === 'users'}"
              ...
              >
                ...
                <div
                  className="rtl:rotate-180"
                  // :className="{'!rotate-90' : activeDropdown === 'users'}"
                >
                  <svg
                    width="16"
                    height="16"
            ...
            <li className="menu nav-item">
              <button
                type="button"
                className="nav-link group"
                // :className="{'active' : activeDropdown === 'pages'}"
              ...
              >
                ...
                <div
                  className="rtl:rotate-180"
                  // :className="{'!rotate-90' : activeDropdown === 'pages'}"
                >
                  <svg
                    width="16"
                    height="16"
              ...
              >
                ...
                <li>
                  <a href="pages-contact-us-boxed.html" target="_blank">
                    Contact Us Boxed
                  </a>
                </li>
                <li>
                  <a href="pages-contact-us-cover.html" target="_blank">
                    Contact Us Cover
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="pages-coming-soon-boxed.html" target="_blank">
                    Coming Soon Boxed
                  </a>
                </li>
                <li>
                  <a href="pages-coming-soon-cover.html" target="_blank">
                    Coming Soon Cover
                  </a>
                </li>
                <li x-data="{subActive:null}">
                  ...
                  >
                    Error
                    <div
                      className="ltr:ml-auto rtl:mr-auto rtl:rotate-180"
                      // :className="{'!rotate-90' : subActive === 'error'}"
                    >
                      {/* <svg
                        width="16"
                        height="16"
                  ...
                  <ul
                    className="sub-menu text-gray-500 ltr:ml-2 rtl:mr-2"
                    x-show="subActive === 'error'"
                    x-collapse
                  >
                    <li>
                    ...
                    <li>
                      <a href="pages-error500.html" target="_blank">
                        500
                      </a>
                    </li>
                    <li>
                      <a href="pages-error503.html" target="_blank">
                        503
                      </a>
                    </li>
                  </ul>
            ...
            <li className="menu nav-item">
              <button
                type="button"
                className="nav-link group"
                // :className="{'active' : activeDropdown === 'authentication'}"
              ...
              >
                ...
                <div
                  className="rtl:rotate-180"
                  // :className="{'!rotate-90' : activeDropdown === 'authentication'}"
                >
                  <svg
                    width="16"
                    height="16"
              ...
              <ul
                x-cloak
                x-show="activeDropdown === 'authentication'"
                x-collapse
                className="sub-menu text-gray-500"
              >
                <li>
