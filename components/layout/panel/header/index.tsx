...
export default function PanelHeader() {
  return (
    <header
      className="z-40"
      // :className="{'dark' : $store.app.semidark && $store.app.menu === 'horizontal'}"
    >
      <div className="shadow-sm">
        <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
          ...
          >
            <div
              className="sm:ltr:mr-auto sm:rtl:ml-auto"
              x-data="{ search: false }"
                ...
                <template x-for="item in languages">
                  <li>
                    <a
                      ...
                      // :className="{'bg-primary/10 text-primary' : $store.app.locale == item.value}"
                    >
                      <img
                        className="h-5 w-5 rounded-full object-cover"
            ...
            >
              ...
              <ul
                ...
                x-transition
                // x-transition.duration.300ms
                className="top-11 w-[300px] !py-0 text-xs text-dark ltr:-right-16 rtl:-left-16 dark:text-white-dark sm:w-[375px] sm:ltr:-right-2 sm:rtl:-left-2"
              >
                <li className="mb-5">
                  <div className="relative overflow-hidden rounded-t-md !p-5 text-white">
                    <div className="absolute inset-0 h-full w-full bg-red bg-cover bg-center bg-no-repeat"></div>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="px-3 dark:text-gray-500">
                        <div
                          className="text-sm font-semibold dark:text-white-light/90"
                          x-text="msg.title"
                        ></div>
                ...
                <template x-if="messages.length">
                  <li className="mt-5 border-t border-white-light text-center dark:border-white/10">
                    <div
                      className="group flex cursor-pointer items-center justify-center px-4 py-4 font-semibold text-primary dark:text-gray-400"
                      // @click="toggle"
                    >
        ...
        {/* <!-- horizontal menu --> */}
        <ul className="horizontal-menu hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-[#0e1726] dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
            ...
            <ul className="sub-menu">
              ...
              <li className="relative">
                ...
                <ul className="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                  ...
                  <li>
                    <a href="datatables-multiple-tables.html">
                      Multiple Tables
                    </a>
                  </li>
                  <li>
