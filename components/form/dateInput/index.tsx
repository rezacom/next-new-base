...
import DP, { DatePickerProps as DPProps, DayValue } from "@hassanmojab/react-modern-calendar-datepicker";
...
interface DatePickerProps
  extends Omit<
    DPProps<DayValue>,
    "value" | "onChange" | "calendarSelectedDayClassName" | "calendarPopperPosition" | "calendarClassName"
  > {
  onSelect?: (value: DayValue) => void;
  value?: DayValue;
  handleFocus?: (event: FocusEvent<HTMLInputElement, Element> | FocusEvent<Element, Element>) => void;
    ...
    <DP
      ...
      renderInput={({ ref }) => (
        <input
          ...
          value={selectedDate ? `${selectedDate.year}/${selectedDate.month}/${selectedDate.day}` : undefined}
          onFocus={(event: FocusEvent<HTMLInputElement, Element> | FocusEvent<Element, Element>) => {
            handleFocus?.(event);
          }}
          dir={dir}
          onBlur={handleBlur}
