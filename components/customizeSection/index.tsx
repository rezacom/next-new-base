...
export default function CustomizeSection() {
  return (
    <div x-data="customizer">
      <div
        className="fixed inset-0 z-[51] hidden bg-[black]/60 px-4 transition-[display]"
        // :className="{'!block': showCustomizer}"
        // @click="showCustomizer = false"
      ></div>

      <nav
        className="fixed bottom-0 top-0 z-[51] w-full max-w-[400px] bg-white p-4 shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 ltr:-right-[400px] rtl:-left-[400px] dark:bg-[#0e1726]"
        // :className="{'ltr:!right-0 rtl:!left-0' : showCustomizer}"
      >
        <a
          href="javascript:;"
        ...
        >
          <svg
            ...
            className="h-5 w-5 animate-[spin_3s_linear_infinite]"
          >
            <circle
              cx="12"
              cy="12"
        ...
        <div className="perfect-scrollbar h-full overflow-y-auto overflow-x-hidden">
          ...
          <div className="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
            ...
            <div className="mt-3 grid grid-cols-3 gap-2">
              <button
                type="button"
                className="btn"
                // :className="[$store.app.theme === 'light' ? 'btn-primary' :'btn-outline-primary']"
              ...
              <button
                type="button"
                className="btn"
                // :className="[$store.app.theme === 'dark' ? 'btn-primary' :'btn-outline-primary']"
              ...
              <button
                type="button"
                className="btn"
                // :className="[$store.app.theme === 'system' ? 'btn-primary' :'btn-outline-primary']"
          ...
          <div className="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
            ...
            <div className="mt-3 grid grid-cols-3 gap-2">
              <button
                type="button"
                className="btn"
                // :className="[$store.app.menu === 'horizontal' ? 'btn-primary' :'btn-outline-primary']"
              ...
              <button
                type="button"
                className="btn"
                // :className="[$store.app.menu === 'vertical' ? 'btn-primary' :'btn-outline-primary']"
              ...
              <button
                type="button"
                className="btn"
                // :className="[$store.app.menu === 'collapsible-vertical' ? 'btn-primary' :'btn-outline-primary']"
          ...
          <div className="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
            ...
            <div className="mt-3 flex gap-2">
              <button
                ...
                // :className="[$store.app.layout === 'boxed-layout' ? 'btn-primary' :'btn-outline-primary']"
              ...
              <button
                type="button"
                className="btn flex-auto"
                // :className="[$store.app.layout === 'full' ? 'btn-primary' :'btn-outline-primary']"
          ...
          <div className="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
            ...
            <div className="mt-3 flex gap-2">
              <button
                type="button"
                className="btn flex-auto"
                // :className="[$store.app.rtlClass === 'ltr' ? 'btn-primary' :'btn-outline-primary']"
              ...
              <button
                type="button"
                className="btn flex-auto"
                // :className="[$store.app.rtlClass === 'rtl' ? 'btn-primary' :'btn-outline-primary']"
